...
def parse_opt_RGB():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'IR.pt', help='model.pt path(s)')
...
def obj_matching(weight):
    ...
    #------------------------------------------------------------------
    ir_label = r"C:\Users\User\Desktop\car\yolo_fusion\testing\IR\labels" #IR 검출 라벨 경로
    rgb_label = r"C:\Users\User\Desktop\car\yolo_fusion\testing\RGB\labels" #RGB 검출 라벨 경로
    target_path = r"C:\Users\User\Desktop\car\yolo_fusion\testing\IR\target_cls.txt" #target_cls.txt 경로
    output_label=r"C:\Users\User\Desktop\car\yolo_fusion\testing\output" #퓨전 라벨 output 경로
    #------------------------------------------------------------------
    # -----------------------------------------------------------------
    names={0:'person',1:'car'} #class (dictionary 형식) 클래스도 맞게 수정할것!
    save_dir=r"C:\Users\User\Desktop\car\yolo_fusion\testing\output" #결과 저장 경로
    # -----------------------------------------------------------------
    ###############################사용시 수정하세요#######################################
    ###############################사용시 수정하세요#######################################
